...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="appointment-form">
                        ...
                        <form action="UpdateAppointmentServlet" method="post" id="appointmentForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" 
                                    value="${appointment.phoneNumber}" required
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="doctor" name="doctor" required>
                                    ...
                                    <option value="Dr. John Smith - Cardiologist" ${appointment.doctorName == 'Dr. John Smith - Cardiologist' ? 'selected' : ''}>
                                        Dr. John Smith - Cardiologist
                                    </option>
                                    <option value="Dr. Sarah Johnson - Neurologist" ${appointment.doctorName == 'Dr. Sarah Johnson - Neurologist' ? 'selected' : ''}>
                                        Dr. Sarah Johnson - Neurologist
                                    </option>
                                    <option value="Dr. Michael Brown - Orthopedic Surgeon" ${appointment.doctorName == 'Dr. Michael Brown - Orthopedic Surgeon' ? 'selected' : ''}>
                                        Dr. Michael Brown - Orthopedic Surgeon
                                    </option>
                                    <option value="Dr. Emily White - Pediatrician" ${appointment.doctorName == 'Dr. Emily White - Pediatrician' ? 'selected' : ''}>
 ...
 <script>
    document.getElementById('phone').addEventListener('input', function() {
        ...
        // Update the field value with digits only
